          ...
          <h1 class="text-center text-light">PAY INVOICE</h1>
            ...
            <form action="includes/payment.inc.php" method="post" 
                ...
                <div class="form-group">
                    ...
                    <input id="cc-number" name="cc-number" type="tel" class="form-control cc-number identified visa" required autocomplete="off" maxlength="16" >
                ...
                <div class="row">
                    ...
                    <div class="col-6 p-0">
                        ...
                        <div class="row">
                            <div class="col pr-0">
                                <input id="x_card_code" name="x_card_code" type="password" class="form-control cc-cvc" required autocomplete="off"maxlength="3">
                            </div>
                            <div class="col pr-0">                            
                                ...
                                <div class="input-group-append">
                                    ...
                                    data-content="<div class='text-center one-card'>The 3 digit code on back of the card..<div class='visa-mc-cvc-preview'></div></div>"                                    data-trigger="hover"></span>
                                    </div>
                                </div>
                            </div>
                        </div>
