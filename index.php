					...
					<div class="tab-1 resp-tab-content oneway">
						<form action="book_flight.php" method="post">
							...
							<div class="date">
								<div class="depart">
									<h3 style="color: rgba(255, 255, 255, 0.767);">Depart</h3>
									<input name="de_date" type="date" 
										class="form-control"  onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'mm/dd/yyyy';}" required="">
								</div>
										<script>
										var today = new Date().toISOString().split('T')[0];
										document.getElementsByName("de_date")[0].setAttribute('min', today);
										</script>
								<div class="return">
									<input class="form-control"  name="ret_date" type="hidden" value="null">
								</div>
								<div class="clear"></div>
							</div>
...
<!-- <div class="conatiner-fluid p-4" style="background-color: whitesmoke;margin-top:150px;"> -->
	...
	<div class="text-light text-center"> <?php echo date('')?> <br><br></div>
	<!-- <p>----------</p> -->
...
<script>
var today = new Date().toISOString().split('T')[0];
document.getElementsByName("ret_date")[0].setAttribute('min', today);
</script>
